...
object Version {
  final val Scala       = "2.12.11" //"2.12.8"
  final val ScalaTest   = "3.0.1"
  final val Vertx       = "3.9.1"
}

object Library {
  val scala_logging                     = "com.typesafe.scala-logging" %% "scala-logging" % "3.9.0"
  val logback_classic                   = "ch.qos.logback" % "logback-classic" % "1.3.0-alpha5"
  val logback_core                      = "ch.qos.logback" % "logback-core" % "1.3.0-alpha5"
  ...
  val bcmail	   	                      = "org.bouncycastle" % "bcmail-jdk15on" % "1.68"
  val bcprov	   	                      = "org.bouncycastle" % "bcprov-ext-jdk15on" % "1.68"
